          ...
          <b-navbar-nav class="lsh_header__login_container">
            ...
            <template v-else>
              <b-nav-item :to="{ name: 'login' }"
                ><b-button
                  variant="dark"
                  class="lsh_btn lsh_btn--primary lsh_btn--round class mr-md-2 mr-lg-0"
                  >Anmelden</b-button
                ></b-nav-item>
              <b-nav-item :to="{ name: 'player-signup' }"
              ><b-button
                variant="dark"
                class="lsh_btn lsh_btn--primary lsh_btn--round class mr-md-2 mr-lg-0"
            ...
            <b-sidebar v-if="loggedIn" id="sidebar-message" title="Messages" right shadow bg-variant="dark" text-variant="light">
              <div class="px-3 py-2">
                <b-list-group>
            ...
            <b-sidebar v-if="loggedIn" id="sidebar-chat" v-bind:title="selectedFriend" right shadow width="500px" style="overflow-y: scroll;">
              <template #footer="{ }">
...
export default {
  ...
  props: ["loggedIn", "user", "isPlayer", "isClub"],
  data() {
    return {
      notification: [],
      threads: [],
