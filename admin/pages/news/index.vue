<template>
  <div class="p-dashboard-body">
    <div class="container admin-dashboard">
      <div class="heading">
        <h3 class="d-inline-block">News</h3>
        <nuxt-link :to="{ name: `news-create` }" class="float-right">
      ...
      <div class="table-section">
        ...
        >
          ...
          <template v-slot:cell(content_picture)="{ item }">
            <a :href="item.content_picture" target="_blank">
              <img
                class="rounded"
                height="30"
                width="30"
          ...
          <template v-slot:cell(actions)="row">
            <nuxt-link :to="{ name: `news-id`, params: { id: row.item.id } }">
              <b-button variant="warning" size="sm">
                <i class="mdi mdi-pencil"></i>
              </b-button>
            </nuxt-link>
            <b-button
              v-if="row.item.id != $auth.user.id"
              variant="danger"
